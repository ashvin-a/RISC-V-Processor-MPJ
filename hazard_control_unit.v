...
assign load_use_hazard = ((i_hcu_ID_EX_MemRead == 1) && ((i_hcu_ID_EX_rd == i_hcu_IF_ID_rs1) || (i_hcu_ID_EX_rd == i_hcu_IF_ID_rs2)) && (i_hcu_ID_EX_rd != 5'b0)) ? 1'b1 : 1'b0;

assign o_hcu_IF_ID_flush =      control_hazard;
assign o_hcu_PCWriteEn =        ~load_use_hazard;
assign o_hcu_IF_ID_write_en =   ~load_use_hazard;
